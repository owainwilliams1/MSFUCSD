            ...
            <>
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                ...
                <Disclosure.Button
                  ...
                  className="px-2 py-1 ml-auto text-gray-500 rounded-md lg:hidden hover:text-msfRed focus:text-msfRed focus:bg-indigo-100 focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700"
                >
                  <svg
